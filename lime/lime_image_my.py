...
class LimeImageExplainer(object):
    ...
    def __init__(self, kernel_width=.25, kernel=None, verbose=False,
                 feature_selection='auto', random_state=None, cam_map=None):
        """Init function.
        ...
        self.base = lime_base_my.LimeBase(kernel_fn, verbose, random_state=self.random_state)

    # 个人修改
    def explain_instance_data_label(self, image, classifier_fn, labels=(1,),
                         hide_color=None,
    ...
    def explain_instance(self, cam_map):
        ...
        if self.top_labels:
            top = np.argsort(self.labels[0])[-self.top_labels:]
        ...
        for label in top:
            (ret_exp.intercept[label],
             ...
             ret_exp.local_pred[label]) = self.base.explain_instance_with_data(
                self.data, self.labels, distances, label, self.num_features, self.image, self.segments, cam_map,
